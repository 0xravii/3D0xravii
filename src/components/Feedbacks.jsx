...
const FeedbackCard = ({
  ...
  >
    ...
    <div className='mt-1'>
      <p className='text-white tracking-wider text-[13px] sm:text-[18px]'>{testimonial}</p>
...
const Feedbacks = () => {
  return (
    <div className={`mt-12 bg-black-100 rounded-[20px]`}>
      ...
      <div className={`-mt-20 pb-14 ${styles.paddingX} flex flex-wrap justify-center gap-5 sm:gap-7`}>
